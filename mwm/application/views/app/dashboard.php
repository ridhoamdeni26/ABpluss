...
function initMap() {
	...
	var beaches = [
		  ['test1', "B 2761 POM", -6.11259, 106.7375],
		  ['test2', "B 4812 SWT", -6.112938, 106.738],
		  ['test3', "B 1111 NIU", -6.113492, 106.7384],
		  ['test4', "B 8901 POL", -6.114809, 106.7376]
		];
